 ...
 * @author chris
 */
public class CreateExpenseType extends javax.swing.JFrame {

    /**
     * Creates new form CreateExpenseType
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!expense_type.getText().isEmpty()) {
            String sql = "insert into expense_types(expense_type) values (?)";
            try {
                pst = conn.connection.prepareStatement(sql);
                pst.setString(1, expense_type.getText());
                pst.execute();
                JOptionPane.showMessageDialog(null, "Expense Type has been Created!");

            } catch (HeadlessException | SQLException e) {
                JOptionPane.showMessageDialog(null, e);
            }
        } else {
             JOptionPane.showMessageDialog(null, "The expense type field is required", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateExpenseType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
