 ...
 * @author Didier
 */
/*This PrintHistoricsupport java class was implemented to get printout.
...
class PrintHistoricsupport {
    ...
    public  static String title[] = new String[] {"Gross Amount","Charges","Net Amount","Previous Balance", ""};
...
//                               }
               ...
               /*Draw Header*/
                   int y=10;
                    g2d.drawString("SACCO KACYIRU", 40,y);  
                    g2d.drawString("History of movement on 03/12/2019 - 03/12/2019", 50,y+10);                 //shift a line by adding 10 to y value
                    g2d.drawString("Date: "+now(), 10, y+20);                                //print date
                    g2d.drawString("Account Number : 310-0001-10", 10, y+30); 
                    g2d.drawString("Client Id : 0000000001", 10, y+40);
