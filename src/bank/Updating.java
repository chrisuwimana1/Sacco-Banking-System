...
public class Updating extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        all_accounts.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cust_Account_No", "Customer_Open_Date"
            }
        ));
    ...
    private void searchAccounts() {
        ...
        try {
            ...
            String sql = "select Account_Number, Customer_Open_Date from customer_information where Customer_Open_Date between ? and ?";
            pst = conn.connection.prepareStatement(sql);
            ...
            while (rs.next()) {
                model.addRow(new Object[]{rs.getString("Account_Number"), (rs.getString("Customer_Open_Date"))});
                //all_accounts.
            }
    ...
    private void update_accountsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_accountsActionPerformed
        ...
        for (int row = 0; row < all_accounts.getRowCount(); row++) {
            ...
            String accountNumber = model.getValueAt(row, 0).toString();
            String accountOpenDate = model.getValueAt(row, 1).toString();
            try {
                String sql = "update account_information set Account_Open_Date =? where Account_Number=?";
                pst = conn.connection.prepareStatement(sql);
                pst.setString(1, accountOpenDate);
