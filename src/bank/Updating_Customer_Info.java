 ...
 * @author User
 */
public class Updating_Customer_Info extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        update_customer_info = new javax.swing.JButton();
        ...
        all_accounts.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cust_Account_No", "Cust_Customer_ID", "Customer_Name", "Account_Number", "Acct_Customer_ID", "Acct_Account_No"
            }
        ));
        ...
        update_customer_info.setText("Update Customer Info");
        update_customer_info.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                update_customer_infoActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(update_customer_info)
                .addGap(103, 103, 103))
        );
    ...
    private void updateCustomerInfo(String customerName) {
...
//        } else {
            try {
                String sql = "update customer_information set Account_Number =?, Account_No =?, Customer_ID=? where Account_Name=? ";
                pst = conn.connection.prepareStatement(sql);
    ...
    private void searchAccounts() {
        ...
        try {
            ...
            //String sql = "select Account_No, Customer_ID, Customer_Name from customer_information where Customer_Open_Date between ? and ?";
            String sql ="SELECT Account_Number, Customer_ID, Customer_Name FROM customer_information where Customer_Open_Date between ? and ? and (Account_Number NOT IN (SELECT Account_Number FROM account_information))";
            ...
            model.addColumn("Cust_Account_No");
            model.addColumn("Cust_Customer_ID");
            model.addColumn("Customer_Name");
            model.addColumn("Account Number");
            model.addColumn("Acct_Customer_ID");
            model.addColumn("Acct_Account_No");
            String customerId = "";
            while (rs.next()) {
                if (rs.getString("Customer_ID").isEmpty()){
                    customerId= "000000"+rs.getString("Account_Number").substring(4,8);
                }else{
                    customerId= rs.getString("Customer_ID");
                }
                model.addRow(new Object[]{rs.getString("Account_Number"), customerId,
                    (rs.getString("Customer_Name")), rs.getString("Account_Number"),
    ...
    private void update_customer_infoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_customer_infoActionPerformed
        // TODO add your handling code here:
        ...
        for (int row = 0; row < all_accounts.getRowCount(); row++) {
            ...
            String accountNumber = model.getValueAt(row, 3).toString();
            String customerID = model.getValueAt(row, 4).toString();
            String account_No = model.getValueAt(row, 5).toString();

            try {
                String sql = "update customer_information set Customer_ID =? where Account_Number=?";
                pst = conn.connection.prepareStatement(sql);
                pst.setString(1, customerID);
                pst.setString(2, accountNumber);
                int update = pst.executeUpdate();
                if (update > 0) {
                    System.out.println("Customer Info has been Updated!");
                }
    ...
    }//GEN-LAST:event_update_customer_infoActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Updating_Customer_Info.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Updating_Customer_Info().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton update_customer_info;
