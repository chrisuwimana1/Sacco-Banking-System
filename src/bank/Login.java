...
public class Login extends javax.swing.JFrame {
    ...
    public void authenticateData(Object empl_title, String uname, String pass) {
        ...
        String sql = "SELECT `id`, `employee_key`, `title`, `firstname`, `lastname`, `username`, `email`, `password`,`salt`, `last_login`, `date_created` FROM `employees` WHERE username = ? AND status=?";
        try {
            pst = conn.connection.prepareStatement(sql);
            ...
            if (set.next()) {
                ...
                else if (empl_title.toString().equalsIgnoreCase("Loan Recovery") && set.getString("title").equalsIgnoreCase(empl_title.toString())) {
                    if (passwordMatch) {
                        this.setCursor(Cursor.getDefaultCursor());
                        IsLogin = true;
                        String employee_key = set.getString("employee_key");
                ...
                JOptionPane.showMessageDialog(null, "Invalid username or password or your account is inactive, call your administrator", "Error", JOptionPane.ERROR_MESSAGE);
                this.setCursor(Cursor.getDefaultCursor());
            }
    ...
    private void initComponents() {
        ...
        empl_title = new javax.swing.JComboBox<String>();
        ...
        empl_title.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Teller", "Adminstrator", "Loan Officer", "Loan Recovery", "Accountant", "Customer Care", "Manager" }));
