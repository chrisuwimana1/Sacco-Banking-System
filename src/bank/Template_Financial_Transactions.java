...
public class Template_Financial_Transactions extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        financial_transactions.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Country", "LE_Book", "Year_Month", "Account_No", "Customer Name", "Process_Ouc", "Card_No", "Merchant_Id", "Transaction_Channel", "Transaction_Code", "Currency", "Trans_Count_DR", "Trans_Count_CR", "Trans_Amount_DR_FCY", "Trans_Amount_DR_FCY", "Trans_Amount_DR_LCY", "Trans_Amount_CR_LCY", "Title 18"
            }
        ));
        ...
        if (from_opening_date.getDate() == null || to_opening_date.getDate() == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    String cu_name = rs.getString("Customer_Name");
