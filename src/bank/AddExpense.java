...
public class AddExpense extends javax.swing.JFrame {
    ...
    private void addExpense() {
        ...
        try {
            ...
            java.util.Date date = specific_date.getDate();
            java.sql.Date sqlDate = new java.sql.Date(date.getTime());

            try {
                //create transaction
                record_transaction(
                        expense_amount, 0, expense_amount, 0,
                        0, sqlDate.toString(), "Withdraw", "",
                        "saccokacyiru", requestees.getSelectedItem().toString(), prefs.get("employee_key", ""));
