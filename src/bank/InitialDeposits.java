...
public class InitialDeposits extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        export.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bank/images/print-icon.png"))); // NOI18N
    ...
    private void exportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportActionPerformed
        ...
        if(dialogResult == JOptionPane.YES_OPTION){
          try {
            ...
            exp.exportTable(list_of_initial_deposits, new File(directoryName+"PartSocials.xls"));
            
            //OPEN FILE
            File tmpDir = new File(directoryName+"PartSocials.xls");
            boolean exists = tmpDir.exists();
              if (exists) {
                  Desktop dt = Desktop.getDesktop();
                  dt.open(new File(directoryName+"PartSocials.xls"));
              }
